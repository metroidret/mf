...
_0806C11E:
	adds r0, r4, #0
	adds r1, r5, #0
	bl ConnectionCheckAreaConnection
	cmp r0, #0
	bne _0806C132
	adds r0, r4, #0
	adds r1, r5, #0
	bl ConnectionCheckEnterDoor
_0806C132:
	pop {r4, r5, r6, r7}
	pop {r0}
	bx r0
...
_0806C610: .4byte gTilemapAndClipPointers
	...
	thumb_func_start BgClipSetBg1BlockValue
BgClipSetBg1BlockValue: @ 0x0806C614
	push {r4, r5, r6, r7, lr}
	lsls r0, r0, #0x10
	lsrs r0, r0, #0x10
	mov ip, r0
...
_0806C6E0: .4byte gTilemapAndClipPointers
	...
	thumb_func_start BgClipSetBg1BlockValueCommon
BgClipSetBg1BlockValueCommon: @ 0x0806C6E4
	push {r4, r5, r6, r7, lr}
	lsls r0, r0, #0x10
	lsrs r0, r0, #0x10
	mov ip, r0
...
_0806C7B0: .4byte 0x083BE740
	...
	thumb_func_start BgClipSetBg1TilemapValue
BgClipSetBg1TilemapValue: @ 0x0806C7B4
	push {r4, r5, lr}
	lsls r0, r0, #0x10
	lsrs r5, r0, #0x10
	lsls r1, r1, #0x10
...
_0806C9EE:
	...
	mov r0, sb
	adds r2, r4, #0
	bl BgClipSetBg1BlockValueCommon
	movs r0, #0x10
	adds r0, r0, r5
	lsls r0, r0, #0x10
	lsrs r0, r0, #0x10
