...
enum SpritePose {
    SPRITE_POSE_UNINITIALIZED = 0,
    SPRITE_POSE_IDLE_INIT = 0x1,
    SPRITE_POSE_IDLE = 0x2,
    SPRITE_POSE_LANDED_INIT = 0x7,
    SPRITE_POSE_LANDED = 0x8,
    SPRITE_POSE_FALLING_INIT = 0x15,
    SPRITE_POSE_FALLING = 0x16,
    SPRITE_POSE_STOPPED = 0x37,
    SPRITE_POSE_EXPLODING = 0x38,
    SPRITE_POSE_DYING_INIT = 0x57,
    SPRITE_POSE_DYING = 0x58,
    SPRITE_POSE_SPAWNING_FROM_X_INIT = 0x59,
    SPRITE_POSE_SPAWNING_FROM_X = 0x5A,
    SPRITE_POSE_TURNING_INTO_X = 0x5B,

    X_PARASITE_POSE_IDLE = 0x5C,
    X_PARASITE_POSE_FLYING = 0x5D,
    X_PARASITE_POSE_GETTING_ABSORBED = 0x5E,
    X_PARASITE_POSE_FLYING_AWAY = 0x61,
    X_PARASITE_POSE_FORMING_INIT = 0x63,
    X_PARASITE_POSE_FORMING = 0x64,
    X_PARASITE_POSE_WAITING_FOR_ENOUGH_X_TO_FORM_INIT = 0x65,
    X_PARASITE_POSE_WAITING_FOR_ENOUGH_X_TO_FORM = 0x66,
};
