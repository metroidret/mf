...
enum RidleyOam {
    ...
    RIDLEY_OAM_UNUSED_FIRE_KANJI,
    RIDLEY_OAM_UNUSED_3AF798,
    RIDLEY_OAM_UNUSED_3AF7D0,
...
extern const struct FrameData sRidleyOam_Unused_FireKanji[2];
extern const struct FrameData sRidleyOam_Unused_3af798[7];
extern const struct FrameData sRidleyOam_Unused_3af7d0[4];
