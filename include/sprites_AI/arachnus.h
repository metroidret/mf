...
#define SPRITE_STATUS_ARACHNUS_HIT_BY_NORMAL_BEAM SPRITE_STATUS_SAMUS_DETECTED
#define SPRITE_STATUS_ARACHNUS_HIT_BY_NORMAL_BEAM_ATTACK_TYPE SPRITE_STATUS_SAMUS_COLLIDING // 0 = shooting fire, 1 = rolling
