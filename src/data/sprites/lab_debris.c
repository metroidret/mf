...
const u16 sLabDebrisOam_Unused_385c8c_Frame0[OAM_DATA_SIZE(2)] = {
    2,
    OAM_ENTRY(-11, -15, OAM_DIMS_16x16, OAM_X_FLIP, 0x211, 8, 0),
    OAM_ENTRY(-3, -23, OAM_DIMS_8x8, OAM_X_FLIP, 0x230, 8, 0),
};

const u16 sLabDebrisOam_Unused_385c9c_Frame0[OAM_DATA_SIZE(2)] = {
    2,
