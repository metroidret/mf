...
const u8 sSector3_20_Clipdata[122] = {
    19, // Room width
    24, // Room height
    _INCBIN_U8("data/rooms/sector_3/sector_3_20_clipdata.rle")
};

const u8 sSector3_20_Bg2[136] = {
    19, // Room width
    24, // Room height
    _INCBIN_U8("data/rooms/sector_3/sector_3_20_bg2.rle")
};

const u8 sSector3_20_Bg1[400] = {
    19, // Room width
    24, // Room height
    _INCBIN_U8("data/rooms/sector_3/sector_3_20_bg1.rle")
};
